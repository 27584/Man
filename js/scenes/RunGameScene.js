    ...
    setupInputListeners() {
        this._onKeyDown = (e) => {
            ...
            if ((e.code === 'ControlLeft' || e.code === 'ControlRight' || e.code === 'ArrowDown')
                && !this.isSliding && !this.isCrossing && this.slideCooldown <= 0) {
                e.preventDefault();
                this.startSliding();
...
getRandomTexture() {
        ...
        this.coins = this.coins.filter((coin) => {
            ...
            if (!coin.userData.collected && this.player) {
                ...
                if (dx < 1.2 && dz < 2.0) {
                    ...
                    const isPlayerJumping = this.isCrossing || playerPos.y > 1.5;
                    
                    if (!isHighCoin || isPlayerJumping) {
    ...
    startSliding() {
        if (this.isCrossing || this.isSliding || !this.animations || this.isGameOver) return;
